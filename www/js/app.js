...
var appSM = {
    ...
    , setIndex: function () {
        ...
        btndelete.addEventListener('touchend', function () {
            if (confirm("Are your sure want to delete this message ?")) {
                console.log("img delete started");
                ...
                data1.append("message_id", mid.value);
                var myInit1 = {
                    mode: "cors"
                    , method: "POST"
                    , body: data1
    ...
    , msgSend: function () {
        ...
        if (recipient_id.value == "" || msg.value == "" || img.getAttribute("src") == "") {
            ...
            //
            var msglgt = BITS.numberToBitArray(msg.value.length*16);
            //
            ...
            var data = new FormData();
            var dataurl = c.toDataURL('image/png', 0.8);
